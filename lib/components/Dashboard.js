...
function Loading(props) {
  return props.isFetching ? React.createElement(
    'div',
    null,
    'Loading'
  ) : '';
...
class Dashboard extends Component {
  ...
  render() {
    ...
    return React.createElement(
      'div',
      { className: 'Dashboard' },
      React.createElement(SecondNavigator, { onClick: this.props.onTodoClick }),
      React.createElement(PostList, { posts: infos.posts }),
      React.createElement(Loading, { isFetching: isFetching })
    );
  }
}
